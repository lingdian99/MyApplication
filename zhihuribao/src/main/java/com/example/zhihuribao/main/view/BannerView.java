...
import com.example.zhihuribao.main.adapter.MyBannerAdapter;
...
public class BannerView extends FrameLayout {
    ...
    private int[] images = new int[]{R.drawable.banner01, R.drawable.banner02, R.drawable.banner01, R.drawable.banner02
            , R.drawable.banner01};
    ...
    public void setBeen(List<TodayNewsList.TopStoriesBean> topStoriesBeen){
    ...
    private void initUI() {
        ...
        for (int i = 0; i <= images.length + 1; i++) {
            ...
            if (i == 0) {
                Glide.with(context).load(topStoriesBeen.get(length-1).getImage()).into(bannerImg);
                bannerText.setText(topStoriesBeen.get(length-1).getTitle());
            } else if (i == length + 1) {
                Glide.with(context).load(topStoriesBeen.get(0).getImage()).into(bannerImg);
                bannerText.setText(topStoriesBeen.get(0).getTitle());
            } else {
                Glide.with(context).load(topStoriesBeen.get(i-1).getImage()).into(bannerImg);
                bannerText.setText(topStoriesBeen.get(i-1).getTitle());
            }
