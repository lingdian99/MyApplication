...
public class SuperRefreshView extends ViewGroup {
    ...
    // SuperRefreshView内的目标View，比如RecyclerView,ListView,ScrollView,GridView
    // etc.
    ...
    public boolean isChildScrollToTop() {
        if (Build.VERSION.SDK_INT < 14) {
            ...
            Log.e("Target", "isChildScrollToTop: "+String.valueOf(!ViewCompat.canScrollVertically(mTarget, -1)));
